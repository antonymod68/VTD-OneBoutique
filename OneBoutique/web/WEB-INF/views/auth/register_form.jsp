        ...
        <div class="col-lg-8 col-md-10">
            <div class="p-5 bg-light rounded-3">
                ...
                <form method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input name="password" value="${password}" type="password" class="form-control" id="passwordInput" placeholder="123456" required>
                        <label for="password">Password</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input name="passwordConfirm" value="${password_confirm}" type="password" class="form-control" id="passwordConfirmInput" placeholder="123456" required>
